                ...
                <tbody>
                    {
                        user.map((user, index) => (
                            <tr key={index} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td className="px-6 py-4">
                                    <Link className="font-medium text-green-600 dark:text-green-500 hover:underline" to={`/viewuser/${user.userID}`} style={{ margin: '0px 10px' }} >View</Link>
                                    <Link className="font-medium text-blue-600 dark:text-blue-500 hover:underline" to={`/edituser/${user.userID}`}>Edit</Link>
